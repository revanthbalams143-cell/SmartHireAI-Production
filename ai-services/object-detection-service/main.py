...
MODEL = None
LOAD_ERROR = None
PROHIBITED = {"cell phone", "phone", "mobile phone", "laptop", "tablet", "remote", "tv", "keyboard", "mouse"}
...
def analyze(payload: ImagePayload):
    ...
    try:
        ...
        results = MODEL(path, verbose=False, conf=float(os.getenv('YOLO_CONFIDENCE', '0.25')))
