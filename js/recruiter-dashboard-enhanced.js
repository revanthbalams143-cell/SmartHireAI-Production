(function(){
  'use strict';
  const API=(window.smartHireApi&&window.smartHireApi.baseUrl)||((location.protocol === "http:" || location.protocol === "https:") ? location.origin : "http://localhost:8080");
