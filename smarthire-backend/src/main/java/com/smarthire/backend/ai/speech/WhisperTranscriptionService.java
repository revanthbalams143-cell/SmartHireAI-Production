...
public class WhisperTranscriptionService {
 ...
 public WhisperTranscriptionService(RestClient.Builder b,@Value("${ai.whisper.url:}") String url,@Value("${ai.whisper.enabled:false}") boolean enabled){this.client=b.build();this.url=com.smarthire.backend.ai.AiServiceUrl.normalize(url);this.enabled=enabled;}
